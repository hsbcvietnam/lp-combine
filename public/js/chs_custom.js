// function callHeight(){
// 	if($(window).width()>=768){
// 		$('.offers').find('.col-sm-4:first-child').find('.description').removeAttr('style');
// 		let h = $('.offers').find('.col-sm-4:first-child').find('.description').height()+100;
// 		$('.offers').find('.col-sm-4').find('.description').css('height', (h)+'px')
// 	}
// }
...
function set_height(){
  ...
  // for(var i = 0; i < 3; i++){
  //   height_item[i].style.height = height_box_item + 170 + "px";
  // }
}

// function set_height_offer(){
//
//   var height_btn_list = $(".chs_offer_box_item.offer_last").height();
//   // alert("1. " + height_btn_list);
//   var z = document.getElementsByClassName("chs_offer_box_item");
//   // for(var i = 0; i < 3; i++){
//   //   z[i].style.height = height_btn_list + 170 + "px";
//   // }
//   if($(window).width()>760 && $(window).width()<980){
//     for(var i = 0; i < 3; i++){
//       z[i].style.height = height_btn_list + 550 + "px";
//     }
//   }
//   else if($(window).width()>=980 && $(window).width()<=1024){
//     for(var i = 0; i < 3; i++){
//       z[i].style.height = height_btn_list + 250 + "px";
//     }
//   }
//   else{
//     for(var i = 0; i < 3; i++){
//       z[i].style.height = height_btn_list + 80 + "px";
//     }
//   }
//
// }
